...
<Columns cols={2}>
  ...
  <Card title="产品定价" icon="book-open" href="/guides/pricing#语音" arrow="true" cta="点击查看">
    各模型的定价说明、计费方式及使用限制。
  </Card>

  <Card title="资源保障" icon="book-open" href="/guides/rate-limits#3、我们的-api-的限速具体数值" arrow="true" cta="点击查看">
...
| 2056  | 超出Coding Plan资源限制       | 请等待下一个时间段资源释放后，再次尝试                                                     |
