from podcast_utils import parse_dialogue, generate_audio_segments, merge_audio_files, validate_script
...
# 创建测试输出目录
test_output_dir = os.path.join(SYSTEM_CONFIG['output_dir'], 'test_full')
...
# 1. 验证文稿格式
print("\n1. 验证文稿格式：")
validation = validate_script(user_input)
...
if audio_files:
    print("\n4. 合并音频文件：")
    final_output = os.path.join(test_output_dir, 'final_podcast.mp3')
